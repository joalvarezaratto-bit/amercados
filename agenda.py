...
_TRAD = {
    ...
    "ISM Manufacturing Prices": "Precios pagados ISM manufacturero EE.UU.",
    "ISM Services Prices": "Precios pagados ISM servicios EE.UU.",
    "ADP Non-Farm Employment Change": "Empleo privado ADP EE.UU.",
    "Average Hourly Earnings m/m": "Salarios por hora EE.UU. (mensual)",
    "Final GDP q/q": "PIB EE.UU. (final)", "Core CPI y/y": "IPC subyacente EE.UU. (anual)",
    "Revised UoM Consumer Sentiment": "Confianza del consumidor (U. Michigan, revisada)",
    "Flash Manufacturing PMI": "PMI manufacturero preliminar EE.UU.",
    "Flash Services PMI": "PMI de servicios preliminar EE.UU.",
    "Crude Oil Inventories": "Inventarios de petróleo EE.UU.",
    "Empire State Manufacturing Index": "Índice manufacturero de Nueva York",
    "Philly Fed Manufacturing Index": "Índice manufacturero de Filadelfia",
    "Building Permits": "Permisos de construcción EE.UU.", "Housing Starts": "Inicios de viviendas EE.UU.",
    "Existing Home Sales": "Ventas de viviendas usadas EE.UU.", "New Home Sales": "Ventas de viviendas nuevas EE.UU.",
    "Durable Goods Orders m/m": "Pedidos de bienes durables EE.UU.",
    "Core Durable Goods Orders m/m": "Pedidos de bienes durables subyacentes EE.UU.",
    "CPI y/y": "IPC China (anual)", "PPI y/y": "Precios al productor China (anual)",
    "New Loans": "Nuevos créditos China", "Retail Sales y/y": "Ventas minoristas China (anual)",
    "Fixed Asset Investment ytd/y": "Inversión en activos fijos China",
    "Federal Budget Balance": "Balance fiscal EE.UU.", "Personal Income m/m": "Ingreso personal EE.UU.",
    "Personal Spending m/m": "Gasto personal EE.UU.", "Treasury Currency Report": "Informe cambiario del Tesoro EE.UU.",
